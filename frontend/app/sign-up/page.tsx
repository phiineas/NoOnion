...
export default function SignUp() {
  ...
  return (
    ...
    <div className="relative bg-gray-800 p-8 rounded shadow-md w-80 flex flex-col items-center justify-center">
        ...
        <h2 className="mb-4 text-xl font-bold text-center text-white">SignUp Today 👇</h2>
        ...
        <div>
            <input 
                type="submit" 
                value="Sign Up" 
                className="w-64 text-white font-bold py-2 px-4 rounded shadow cursor-pointer bg-rose-500 hover:bg-rose-600"
            />
        </div>
        </form>
        <div className="mt-4 text-center">
        <p className="text-lg text-white">
            Already have an account? <Link href="/sign-in" className="underline text-blue-400 hover:text-blue-700">Sign in</Link>
        </p>
        </div>
    </div>
    </div>
